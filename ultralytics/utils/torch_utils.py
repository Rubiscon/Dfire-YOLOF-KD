...
class ModelEMA:
    ...
    def update(self, model):
        ...
        if self.enabled:
            ...
            # Guard against tied/shared weights (e.g. a shared backbone exposed under two
            # state_dict keys): update each underlying storage only once to avoid double decay.
            seen: set[int] = set()
