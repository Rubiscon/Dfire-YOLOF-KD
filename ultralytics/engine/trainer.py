...
class BaseTrainer:
    ...
    def _setup_train(self):
        ...
        if self.world_size > 1:
            ...
            # o2m+o2o pose loss branches) under torch.compile. Incompatible with find_unused_parameters.
            ddp_kw = self.ddp_kwargs()
            static_graph = bool(self.args.compile) and not ddp_kw.get("find_unused_parameters", False)
    ...
    def setup_model(self):
        ...
        if str(self.model).endswith(".pt"):
            ...
            cfg = weights.yaml
        # Resume must load only from the checkpoint path above; never overwrite with pretrained.
    ...
    def ddp_kwargs(self) -> dict:
        """Extra ``DistributedDataParallel`` kwargs (override in subclasses)."""
        return {}
