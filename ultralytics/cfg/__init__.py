...
def check_dict_alignment(
    ...
    # Allow user-defined training parameters that are not part of the core default config.
    if allowed_custom_keys is None:
        allowed_custom_keys = {
            ...
            "align",
            "online_distill",
            "teacher_freeze_epoch",
            "teacher_freeze_use_ema",
            "distill_temperature",
            "feature_norm",
            "align_box",
            "align_cls",
            ...
            "dict_attn_mode",
            "dict_attn_warmup_epochs",
            "dict_grad_log_interval",
            "dict_train_encoders",
            "dict_weight",
            "dict_match",
            "dict_match_profile",
